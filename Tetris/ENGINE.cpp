...
void ENGINE::next_step(int key) {
	...
	case 1: //left
		...
		case 13:
		case 19:
			if (isValid(tmp_figure[0].x - 1, tmp_figure[0].y) && isValid(tmp_figure[1].x - 1, tmp_figure[1].y))
				if (game_settings->get_game_map()[tmp_figure[0].x - 1][tmp_figure[0].y] == 0 && game_settings->get_game_map()[tmp_figure[1].x - 1][tmp_figure[1].y] == 0) {
					decrement_tmp_x();
				}
			break;
		case 6:
		...
		case 14:
		case 18:
			if (isValid(tmp_figure[0].x - 1, tmp_figure[0].y) && isValid(tmp_figure[1].x - 1, tmp_figure[1].y) && isValid(tmp_figure[2].x - 1, tmp_figure[2].y))
				if (game_settings->get_game_map()[tmp_figure[0].x - 1][tmp_figure[0].y] == 0 && game_settings->get_game_map()[tmp_figure[1].x - 1][tmp_figure[1].y] == 0 && game_settings->get_game_map()[tmp_figure[2].x - 1][tmp_figure[2].y] == 0) {
					decrement_tmp_x();
				}
			break;
		case 12:
		case 16:
			if (isValid(tmp_figure[0].x - 1, tmp_figure[0].y) && isValid(tmp_figure[2].x - 1, tmp_figure[2].y) && isValid(tmp_figure[3].x - 1, tmp_figure[3].y))
				if (game_settings->get_game_map()[tmp_figure[0].x - 1][tmp_figure[0].y] == 0 && game_settings->get_game_map()[tmp_figure[2].x - 1][tmp_figure[2].y] == 0 && game_settings->get_game_map()[tmp_figure[3].x - 1][tmp_figure[3].y] == 0) {
					decrement_tmp_x();
				}
			break;
		case 15:
		case 17:
			if (isValid(tmp_figure[0].x - 1, tmp_figure[0].y) && isValid(tmp_figure[3].x - 1, tmp_figure[3].y))
				if (game_settings->get_game_map()[tmp_figure[0].x - 1][tmp_figure[0].y] == 0 && game_settings->get_game_map()[tmp_figure[3].x - 1][tmp_figure[3].y] == 0) {
					decrement_tmp_x();
				}
			break;
		default:
	...
	case 2: // right
		...
		case 15:
		case 17:
			if (isValid(tmp_figure[2].x + 1, tmp_figure[2].y) && isValid(tmp_figure[3].x + 1, tmp_figure[3].y))
				if (game_settings->get_game_map()[tmp_figure[2].x + 1][tmp_figure[2].y] == 0 && game_settings->get_game_map()[tmp_figure[3].x + 1][tmp_figure[3].y] == 0) {
					increment_tmp_x();
				}
			break;
		case 6:
	...
	case 3: // down
		...
		case 5:
		case 9:
			if (isValid(tmp_figure[0].x, tmp_figure[0].y + 1) && isValid(tmp_figure[2].x, tmp_figure[2].y + 1) && isValid(tmp_figure[3].x, tmp_figure[3].y + 1))
				if (game_settings->get_game_map()[tmp_figure[0].x][tmp_figure[0].y + 1] == 0 && game_settings->get_game_map()[tmp_figure[2].x][tmp_figure[2].y + 1] == 0 && game_settings->get_game_map()[tmp_figure[3].x][tmp_figure[3].y + 1] == 0) {
					increment_tmp_y();
					break;
				}
			fix_tmp_figure();
		...
		case 11:
		case 16:
			if (isValid(tmp_figure[1].x, tmp_figure[1].y + 1) && isValid(tmp_figure[3].x, tmp_figure[3].y + 1))
				if (game_settings->get_game_map()[tmp_figure[1].x][tmp_figure[1].y + 1] == 0 && game_settings->get_game_map()[tmp_figure[3].x][tmp_figure[3].y + 1] == 0) {
					increment_tmp_y();
					break;
				}
			fix_tmp_figure();
			...
			break;
		case 12:
			if (isValid(tmp_figure[0].x, tmp_figure[0].y + 1) && isValid(tmp_figure[3].x, tmp_figure[3].y + 1))
				if (game_settings->get_game_map()[tmp_figure[0].x][tmp_figure[0].y + 1] == 0 && game_settings->get_game_map()[tmp_figure[3].x][tmp_figure[3].y + 1] == 0) {
					increment_tmp_y();
					break;
				}
			fix_tmp_figure();
			...
			break;
		case 17:
			if (isValid(tmp_figure[0].x, tmp_figure[0].y + 1) && isValid(tmp_figure[1].x, tmp_figure[1].y + 1) && isValid(tmp_figure[3].x, tmp_figure[3].y + 1))
				if (game_settings->get_game_map()[tmp_figure[0].x][tmp_figure[0].y + 1] == 0 && game_settings->get_game_map()[tmp_figure[1].x][tmp_figure[1].y + 1] == 0 && game_settings->get_game_map()[tmp_figure[3].x][tmp_figure[3].y + 1] == 0) {
					increment_tmp_y();
					break;
				}
			fix_tmp_figure();
